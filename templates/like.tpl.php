...
<div class="like-container-<?php print $entity ?>" id="like-container-<?php print $eid; ?>">
  <div class="like inline float-left">
    <?php if ($likestatus == 0): ?>
      <a href="javascript:;" data-eid="<?php print $eid; ?>" class="<?php print $entity ?>"><img src="<?php print $path ?>/images/like.gif" alt="Like" title="Like" class="<?php print $entity ?>"></a>
    <?php endif; ?>
    <?php if ($likestatus == 1): ?>
      <a href="javascript:;" data-eid="<?php print $eid; ?>" class="disable-status <?php print $entity ?>"><img src="<?php print $path ?>/images/likeAct.gif" alt="Like" title="Like" class="<?php print $entity ?>"></a>
    <?php endif; ?>
  </div>
